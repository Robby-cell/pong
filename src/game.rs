...
impl Ball {
    ...
    pub fn collision(&mut self, what: Direction) {
        match what {
    ...
    pub fn collision_player(&mut self, what: Direction, what_direction: Direction) {
    ...
    pub fn corner_collision(&mut self, what_side: Direction, top_or_bottom: Direction) {
    ...
    pub fn end_collision(&mut self, end: Direction) {
        self.y_dir = end;
    }
}
